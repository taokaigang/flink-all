...
import com.flink.flinksql.flinkcdc.CustomerRowDebeziumDeserializationSchemaV2;
...
public class FlinkCdcMultiSyncJdbc {
    ...
    // 本地运行参数
    // --mysql_with_body_path /data/flink-study/sql/connector_with_body/mysql_with_body --username root --password 123456789 --host 127.0.0.1 --db flinksql_test
