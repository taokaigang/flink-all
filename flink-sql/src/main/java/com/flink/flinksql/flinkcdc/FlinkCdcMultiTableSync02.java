...
public class FlinkCdcMultiTableSync02 {
    private static final Logger log = LoggerFactory.getLogger(FlinkCdcMultiTableSync02.class);
    public static void main(String[] args) throws Exception {
        ...
        properties.put("time.precision.mode","adaptive_time_microseconds");
        MySqlSource<Tuple2<String,Row>> mySqlSource = MySqlSource.<Tuple2<String,Row>>builder()
                ...
                .build();
        SingleOutputStreamOperator<Tuple2<String, Row>> dataStreamSource = env.fromSource(mySqlSource, WatermarkStrategy.noWatermarks(), "mysql cdc");
